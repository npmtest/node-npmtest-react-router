...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-router/node_modules/react-router/MemoryRouter.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-router/node_modules/react-router/MemoryRouter.js</span></h1>
    <h2>
        
        Statements: <span class="metric">67.57% <small>(25 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">43.48% <small>(10 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-router/node_modules/react-router/</a> &#187; MemoryRouter.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function MemoryRouter() {</span>
<span class="cstat-no" title="statement not covered" >    var _temp, _this, _ret;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, MemoryRouter);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = (0, _createMemoryHistory2.default)(_this.props), _temp), _possibleConstructorReturn(_this, _ret);</span>
  }
&nbsp;
  MemoryRouter.prototype.render = <span class="fstat-no" title="function not covered" >function render() {</span>
<span class="cstat-no" title="statement not covered" >    return _react2.default.createElement(_Router2.default, { history: this.history, children: this.props.children });</span>
  };
&nbsp;
  return MemoryRouter;
